...
public class HitbController {
	...
	public String urltran(String url) throws Throwable{
		...
		try {
			...
			jedis.close();
			String turl="http://pub.alimama.com/urltrans/urltrans.json?siteid=3406996&adzoneid=22076161&promotionURL="+java.net.URLEncoder.encode(url,"utf-8")+"&t=1480063247548&pvid=&_tb_token_=DJWghTHg67q&_input_charset=utf-8";
